/* We'll make a newsletter sign up form with more error checking and validation
We will change a couple of small things in our HTML:
- adding the required attribute to the input elements that are compulsory information for the user 
to fill out and fill out properly
- adding labels instead of p elements
We'll add CSS styling to our elements to indicate validation status */
